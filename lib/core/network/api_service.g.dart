...
class _ApiService implements ApiService {
  ...
  @override
  Future<GetPostsResponseBody> communityPosts() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<RoutineResponseModel> fetchRoutinesByLevelId(int levelId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RoutineResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RoutineResponseModel _value;
    try {
      _value = RoutineResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<CreatePostResponseModel> createCommunityPost(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CreatePostResponseModel _value;
    try {
      _value = CreatePostResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<CreateCommentResponseModel> createComment(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(createCommentRequestModel.toJson());
    final _options = _setStreamType<CreateCommentResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CreateCommentResponseModel _value;
    try {
      _value = CreateCommentResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
